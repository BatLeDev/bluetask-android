...
This is the Android version of the BlueTask project. It is a simplified version of the web application, focusing on task management and user authentication.
...
For more details of the BlueTask project, visit the [BlueTask repository](https://github.com/BatLeDev/bluetask).
...
[Download the APK](https://github.com/BatLeDev/bluetask-android/releases/tag/v1.0) and install it on your Android device.
